// Aitu_SE2315_YussupovZhangir-test.js
const { expect } = require("chai");
const { ethers } = require("hardhat");

describe("Aitu_SE2315_YussupovZhangir Contract", function () {
  let owner, addr1, addr2, contract;

  beforeEach(async function () {
    [owner, addr1, addr2] = await ethers.getSigners();
    const Aitu_SE2315_YussupovZhangir = await ethers.getContractFactory("Aitu_SE2315_YussupovZhangir");
    contract = await Aitu_SE2315_YussupovZhangir.deploy(owner.address);
  });
